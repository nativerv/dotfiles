...
user_pref("layout.css.prefers-color-scheme.content-override", "dark"); // Get back prefers color theme (RFP sets it to light)
...
/* 200b: https://github.com/arkenfox/user.js/issues/1080 - // removed from user.js v91 */
...
user_pref("browser.tabs.tabmanager.enabled", false); // [FF67+] [HIDDEN PREF] 0=light, 1=dark: with RFP this only affects chrome
/* UX BEHAVIOR ***/
user_pref("browser.quitShortcut.disabled", true); // disable Ctrl-Q quit shortcut [LINUX] [MAC] [FF87+]
user_pref("browser.urlbar.decodeURLsOnCopy", true); // see bugzilla 1320061 [FF53+]
...
user_pref("extensions.pocket.enabled", false); // Up-to-date - Pocket Account [FF46+]
...
user_pref("layout.css.prefers-color-scheme.content-override", 2); // Get back prefers color theme (RFP sets it to light)
...
user_pref("gfx.webrenderer.all", true);
// Firefox VAAPI decoding doesn't seem to support AV1 yet (even though the GPU
// in the framework can do it); it will fall back to using the CPU decoder;
// "dav1d". YouTube is slowly rolling out AV1; some videos have it and some
// don't. Disabling AV1 support in Firefox will force YouTube to serve you the
// VP9 or H264 version, which should decode in hardware. VP9/H264 video may be
// lower in quality/higher in file size, but the tradeoff is probably worth it
// to save battery and reduce heat/noise output
user_pref("media.av1.enabled", false); // [DEFAULT: true]
