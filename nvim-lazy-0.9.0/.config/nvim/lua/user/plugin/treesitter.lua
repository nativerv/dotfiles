...
M.setup = function()
  ...
  -- Define TSInstallWanted command that installs everything that i want (but
  -- does not do it at first start which breaks low perf stuff)
  vim.api.nvim_create_user_command('TSInstallWanted', function()
    local wanted_parsers = {
      "bash", "c", "c_sharp", "comment", "cpp", "diff", "dockerfile", "elm",
      "go", "haskell", "haskell_persistent", "html", "java", "javascript",
      "json", "jsonc", "kotlin", "latex", "lua", "luadoc", "markdown",
      "markdown_inline", "nix", "passwd", "pymanifest", "python", "query",
      "rust", "todotxt", "typescript", "vim", "vimdoc", "yaml", "yuck",
    }
