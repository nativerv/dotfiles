...
M.on_attach = function(_, bufnr)
  ...
  if pcall(require, 'which-key') then
    require('which-key').register {
      g = {
        D = { name = 'Lsp goto declaration' },
        d = { name = 'Lsp goto definition' },
        h = { name = 'Lsp hover' },
        H = { name = 'Lsp signature help' },
        t = { name = 'Lsp goto type definition' },
        n = { name = 'Lsp rename' },
        i = { name = 'Lsp goto implementation' },
        r = { name = 'Lsp goto references' },
        y = { name = 'Lsp code actions' },
        l = { name = 'Lsp diagnostics' },
        E = { name = 'Lsp previous error' },
        e = { name = 'Lsp next error' },
      },
    }
  end
